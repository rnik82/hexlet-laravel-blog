...
// Ресурсная маршрутизация. Вместо описания 7 разных маршрутов, она позволяет указать один метамаршрут:
Route::resource('articles', ArticleController::class);

// Название сущности (articles) в URL во множественном числе, контроллер (index) в единственном
...
// Маршрут для просмотра конкретной статьи.
